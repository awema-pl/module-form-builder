...
<form-builder url="/send/5" disabled-dialog
    ...
    <template slot-scope="{ fields }">
        ...
        <div class="grid__cell"><div class="v-popover display-block"><span aria-describedby="popover_x2dqybnzl2" tabindex="-1" class="trigger" style="display: inline-block;"><span class="display-block fc-radio"><label class="fc-radio__box"><input type="radio" data-awema="fb-radio-group.type" class="fc-radio__field is-focusable in-focus" value="Company"> <span class="fc-radio__text">Company</span></label><label class="fc-radio__box is-checked"><input type="radio" data-awema="fb-radio-group.type" class="fc-radio__field is-focusable in-focus" value="Freelancer"> <span class="fc-radio__text">Freelancer</span></label></span> <!----></span> </div></div>
