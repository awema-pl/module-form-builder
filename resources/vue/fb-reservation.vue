...
export default {
    ...
    methods: {
        ...
        fetchData() {
            AWEMA.on('core:ajax', this._showLoader)
            ...
            AWEMA.ajax({timezone: this.timeZone, range_start, range_end}, this.url, 'GET')
                .then( ({ data }) => {
                ...
                .finally(() => {
                    ...
                    AWEMA.off('core:ajax', this._showLoader)
                })
        },
        ...
        _handleError(err) {
            if ( ! AWEMA.utils.object.isEmpty(err) ) {
                this.inputError = err
            }
        },
